...
from api.player_grades import router as player_grades_router
from api.rosters import router as rosters_router
...
app.include_router(player_grades_router, prefix="/player-grades", tags=["player-grades"])
